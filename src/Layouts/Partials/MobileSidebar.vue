        ...
        <div class="relative flex-1 flex flex-col max-w-xs w-full pt-5 pb-4 bg-white">
          <TransitionChild as="template" enter="ease-in-out duration-300" enter-from="opacity-0" enter-to="opacity-100" leave="ease-in-out duration-300" leave-from="opacity-100" leave-to="opacity-0">
            <div class="absolute top-0 right-0 -mr-12 pt-2">
              <button class="ml-1 flex items-center justify-center h-10 w-10 rounded-full focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" @click="$emit('close-sidebar')">
              ...
              <ul class="list-none">
                ...
                >
                  ...
                  >
                    ...
                    <a :href="href" @click="navigate , sidebarOpen = false" class="text-gray-600 text-sm font-medium w-full py-4">{{ item.name }}</a>
                  </li>
                </router-link>
              </ul>
            </nav>
